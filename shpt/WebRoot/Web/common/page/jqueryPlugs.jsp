...
<!-- validate前台输入验证插件 -->
<script src="<%=root%>/Web/common/js/validate/jquery.validate.js" type="text/javascript"></script>
<script src="<%=root%>/Web/common/js/validate/cmxforms.js" type="text/javascript"></script>
<script src="<%=root%>/Web/common/js/validate/tools.js" type="text/javascript"></script>
<script src="<%=root%>/Web/common/js/validate/messages_cn.js" type="text/javascript"></script>
...
<!-- DatePicker时间插件 -->
<script type="text/javascript" src="<%=root%>/Web/common/js/My97DatePicker/WdatePicker.js"></script>
...
<!-- 自动完成 -->
<link href="<%=root%>/Web/common/css/jquery.autocomplete.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<%=root%>/Web/common/js/jquery.autocomplete.min.js"></script>
